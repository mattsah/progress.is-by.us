...
CREATE TABLE bills(
	...
	sponsor INTEGER NOT NULL REFERENCES legislators(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE reports(
	...
	bill INTEGER NOT NULL REFERENCES bills(id) ON DELETE CASCADE ON UPDATE CASCADE,
 	legislator INTEGER NOT NULL REFERENCES legislators(id) ON DELETE CASCADE ON UPDATE CASCADE,
